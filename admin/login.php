...
<head>
    ...
    <style>
       ...
       .login-card {
            position: relative; /* Menjadi patokan posisi logo */
            width: 100%;
            max-width: 420px;
            background: rgba(11, 19, 43, 0.75);
            backdrop-filter: blur(10px);
            -webkit-backdrop-filter: blur(10px);
            padding: 110px 40px 45px 40px; /* Ditambah padding atas (110px) agar form tidak tertimpa logo */
            border-radius: 16px;
            color: #ffffff;
        ...
        .admin-logo-container {
            position: absolute;
            top: -60px; /* Memaksa logo naik ke atas keluar dari garis card */
            left: 50%;
            transform: translateX(-50%); /* Agar posisi logo pas tepat di tengah-tengah */
            width: 100%;
            text-align: center;
            z-index: 10;
        }
        ...
        .admin-logo-container img {
            width: 250px; /* Di-zoom lebih besar sesuai maumu */
            height: auto;
            object-fit: contain;
