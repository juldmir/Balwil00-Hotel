...
<form class="row g-3" method="get">
    <div class="col-auto">
        <input type="text" class="form-control" placeholder="Masukkan Nama Tipe" name="katakunci" value="<?php echo $katakunci ?>" />
    </div>
    <div class="col-auto">
    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td>
                    <?php if($r1['foto'] != '') { ?>
                        <img src="../gambar/<?php echo $r1['foto'] ?>" style="max-height:100px;max-width:100px; border-radius:5px;"/>
                    <?php } else { echo "-"; } ?>
                </td>
                ...
                <td>
                    ...
                    <a href="tipe_kamar.php?op=delete&id=<?php echo $r1['id_tipe'] ?>" class="text-decoration-none" onclick="return confirm('Yakin mau hapus tipe kamar ini?')">
...
<nav aria-label="Page navigation example">
    <ul class="pagination">
        ...
        for($i=1; $i <= $pages; $i++){
            ?>
            <li class="page-item">
                <a class="page-link" href="tipe_kamar.php?katakunci=<?php echo $katakunci?>&cari=<?php echo $cari?>&page=<?php echo $i ?>"><?php echo $i ?></a>
            </li>
            <?php
        }
        ?>
